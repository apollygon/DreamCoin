...
The following applies to code changes to the DREM Core project, and is not to be
confused with overall DREM Network Protocol consensus changes.

Whether a pull request is merged into DREM Core rests with the project merge
...
Patches that change DREM consensus rules are considerably more involved than
...
Where a patch set proposes to change the DREM consensus, it must have been
...
The project leader is the release manager for each DREM Core release.
