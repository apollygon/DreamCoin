...
if [[ ! -e "autogen.sh" ]]
then
    echo "autogen.sh is not found, not root directory of DreamPay repository?"
    exit 1
fi
...
if [[ ! -e "src/drem-cli" ]]
then
    echo "drem-cli was not found"
    exit 1
fi

if [[ ! -e "src/drem-tx" ]]
then
    echo "drem-tx was not found"
    exit 1 
fi

if [[ ! -e "src/dremd" ]]
then
    echo "dremd was not found"
    exit 1 
fi

if [[ ! -e "src/qt/drem-qt" ]]
then
    echo "drem-qt was not found"
    exit 1 
fi
