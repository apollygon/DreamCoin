...
RESOURCES += src/qt/drem.qrc src/qt/drem_locale.qrc

TRANSLATIONS += src/qt/locale/drem_bg.ts \
                src/qt/locale/drem_de.ts \
                src/qt/locale/drem_en.ts \
                src/qt/locale/drem_es.ts \
                src/qt/locale/drem_fi.ts \
                src/qt/locale/drem_fr.ts \
                src/qt/locale/drem_it.ts \
                src/qt/locale/drem_ja.ts \
                src/qt/locale/drem_pl.ts \
                src/qt/locale/drem_pt.ts \
                src/qt/locale/drem_ru.ts \
                src/qt/locale/drem_sk.ts \
                src/qt/locale/drem_sv.ts \
                src/qt/locale/drem_vi.ts \
                src/qt/locale/drem_zh_CN.ts \
                src/qt/locale/drem_zh_TW.ts
