...
This means one can have an always-on dremd instance running, and another local dremd/drem-qt instance which connects to this node and receives blocks from it.
