...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<drem_address\> \<monthly_payment_drem\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ DREM, _12_ times over the course of a year totaling _24000_ DREM.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<drem_address\> \<monthly_payment_drem\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` DREM.
