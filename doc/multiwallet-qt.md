...
In order to support loading of multiple wallets in drem-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is drem.cpp.
...
Changes to drem.cpp
----------------------
drem.cpp is the entry point into drem-qt, and as such, will require some minor modifications to provide hooks for
