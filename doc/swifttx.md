...
This mechanism has been integrated into Bitcore-Node-DREM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DREM-Project/insight-api-drem#web-socket-api](https://github.com/DREM-Project/insight-api-drem#web-socket-api)
* API: [https://github.com/DREM-Project/insight-api-drem#swifttx-transactions](https://github.com/DREM-Project/insight-api-drem#swifttx-transactions)
...
By default, the DREM Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DREM Core daemon:
