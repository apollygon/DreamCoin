...
#if defined(NDEBUG)
#error "DREM cannot be compiled without assertions."
#endif
...
{
    /**
     * Block 1: 12 Billions DREM pre-mined
     Block Reward:
     Blocks 2 - 151,200 - 2500 DREM
     Blocks 151,201 - 302,399 - 1250 DREM
     Blocks 302,400 - Infinite:  1000 DREM
