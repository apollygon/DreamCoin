                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DreamPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DreamPay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and drem: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DreamPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about DreamPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DreamPay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DreamPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DreamPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a DreamPay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DreamPay Core help message to get a list with possible DreamPay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DreamPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DreamPay network", "", count));
}
...
{
    QString strTitle = tr("DreamPay Core"); // default title
