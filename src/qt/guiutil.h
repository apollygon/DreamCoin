...
/** Utility functions used by the DreamPay Qt UI.
 */
namespace GUIUtil
{
...
// Render DreamPay addresses in monospace font
...
// Parse "drem:" URI into recipient object, return true on successful parsing
