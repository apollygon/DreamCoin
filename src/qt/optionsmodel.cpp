...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::DREM);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePivxAmount"))
        SoftSetArg("-anonymizedremamount", settings.value("nAnonymizePivxAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in drem.cpp during shotdown to also remove the window positions
