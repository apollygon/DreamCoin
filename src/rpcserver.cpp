...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"drem", "masternode", &masternode, true, true, false},
        {"drem", "masternodelist", &masternodelist, true, true, false},
        {"drem", "mnbudget", &mnbudget, true, true, false},
        {"drem", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"drem", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"drem", "mnsync", &mnsync, true, true, false},
        {"drem", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"drem", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dremd, or the -server option to drem-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> drem-cli " + methodname + " " + args + "\n";
}
